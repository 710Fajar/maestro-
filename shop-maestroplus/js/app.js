            ...
            <div class="bg-white sticky top-0 z-10 shadow-sm">
                <div class="flex items-center p-4">
                    ...
                    ${
                        unreadCount > 0
                            ? `
                        <button onclick="markAllAsRead()" class="text-[#8200] text-sm font-medium">
                        </button>
                    `
                            : ''
                    }
                    ...
                    <div class="flex items-center gap-4">
                        <button onclick="navigate('wishlist')" class="relative">
                            ...
                            ${
                                wishlist.length > 0
                                    ? `
                                <span class="absolute -top-1 -right-1 w-2 h-2 bg-green-100 rounded-full"></span>
                            `
                                    : ''
                            }
                        </button>
            ...
            <div class="px-4 mb-6">
                <div class="overflow-x-auto scroll-smooth flex space-x-4 pb-4">
                    ${promotions.map(promo => `
                        <div class="flex-shrink-0 w-80 bg-gradient-to-r from-[#820000] to-[#6b0000] rounded-lg p-4 text-white">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <button class="bg-white text-[#820000] px-4 py-1 rounded-full text-sm font-bold">
                                    Copy
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="product-card bg-white rounded-lg shadow-md overflow-hidden" 
                        ...
                        <div class="p-4">
                            <div class="flex justify-between items-center mb-2">
                                <span class="text-[#820000] font-medium">
                                    ${
                                        product.available
                                            ? 'In Stock'
                                            : 'Out of Stock'
                            ...
                            <div class="flexbox justify-between items-center">
                                <div class="text-xl font-bold ">${formatCurrency(product.price)}</div>
                                <button onclick="event.stopPropagation(); addToCart(${
                                    product.id
                                })" 
                                        class="ripple bg-gradient-to-r from-[#820000] to-[#6b0000] text-white px-4 py-2 rounded-lg flex items-center">
        ...
        <div class="pb-16">
            ...
            <div class="bg-white p-4 mb-4">
                <div class="flex justify-between items-start mb-4">
                    ...
                    <div class="text-3xl font-bold text-[#820000]">${formatCurrency(selectedProduct.price)}</div>
                </div>
                    ...
                    <ul class="space-y-2">
                        ${selectedProduct.specs
                            ...
                            <li class="flex items-center">
                                <i class="fas fa-check text-[#820000] mr-2"></i>
                                ${spec}
                            </li>
                        `
                            )
                ...
                <div class="fixed bottom-0 left-0 right-0 bg-white p-4 shadow-lg flex space-x-4">
                    <button onclick="addToCart(selectedProduct.id)" 
                            class="flex-1 bg-gradient-to-r from-[#820000] to-[#6b0000] text-white py-3 rounded-lg font-semibold flex items-center justify-center">
                        <i class="fas fa-cart-plus mr-2"></i>
                        Add to Cart
                    </button>
            ...
            ${
                ...
                <div class="flex flex-col items-center justify-center p-8">
                    ...
                    <button onclick="navigate('home')" 
                            class="mt-4 text-[#820000] font-semibold">
                        Continue Shopping
                    </button>
                </div>
            `
    ...
    return `
        <div class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 pb-safe-area">
            <div class="flex justify-around items-center py-3">
                <button onclick="navigate('home')" 
                    class="flex flex-col items-center ${currentPage === 'home' ? 'text-[#820000]' : 'text-gray-600'}">
                    <i class="fas fa-home text-xl mb-1"></i>
                    <span class="text-xs">Home</span>
                </button>
                <button onclick="navigate('search')"
                    class="flex flex-col items-center ${currentPage === 'search' ? 'text-[#820000]' : 'text-gray-600'}">
                    <i class="fas fa-search text-xl mb-1"></i>
                    <span class="text-xs">Search</span>
                </button>
                <button onclick="navigate('cart')"
                    class="flex flex-col items-center ${currentPage === 'cart' ? 'text-[#820000]' : 'text-gray-600'}">
                    <div class="relative">
                ...
                <button onclick="navigate('profile')"
                    class="flex flex-col items-center ${currentPage === 'profile' ? 'text-[#820000]' : 'text-gray-600'}">
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="relative px-6 pb-6">
                ...
                <form id="profile-form" onsubmit="updateProfile(event)" class="space-y-4 mt-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="profile-name" value="${authState.currentUser.name}" required
                                class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-[#820000] focus:border-transparent">
                        </div>
                        <div class="form-group">
                    ...
                    <button type="submit" 
                        class="w-full bg-gradient-to-r from-[#820000] to-[#6b0000] text-white py-3 px-4 rounded-lg hover:from-[#6b0000] hover:to-[#820000] transition-all duration-300 flex items-center justify-center">
                    ...
                    ${userOrders.slice(0, 5).map(order => `
                        <div class="border rounded-lg p-4">
                            ...
                            <div class="text-sm text-gray-600">
                                ...
                                <p>Total: ${formatCurrency(order.payment.total)}</p>
                            </div>
                            <button onclick="viewOrderDetails('${order.orderId}')" 
                                class="mt-2 text-[#820000] text-sm font-medium">
                                View Details
                            </button>
                        </div>
                    `).join('')}
                </div>
                <button onclick="viewAllOrders()" class="mt-4 text-[#820000] hover:text-[#6b0000] font-medium">
                    View All Orders
                </button>
            ` : `
                <div class="text-center py-8 text-gray-500">
                    ...
                    <p>No orders yet</p>
                    <button onclick="navigate('home')" class="mt-2 bg-[#820000] hover:bg-[#820000] text-white px-6 py-2 rounded-lg font-semibold transition-all duration-300">
                        Start Shopping
                    </button>
                </div>
            `}
    ...
    return `
        <div class="bg-white rounded-lg shadow-lg p-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <button onclick="addNewAddress()" class="text-#820000 hover:text-green-700">
            ...
            <div class="bg-white sticky top-0 z-10">
                ...
                <div class="flex justify-between px-8 py-4 border-t">
                    <div class="flex flex-col items-center">
                        <div class="w-8 h-8 rounded-full bg-[#820000]    text-white flex items-center justify-center mb-1">
                            <i class="fas fa-shopping-cart"></i>
                        </div>
                        <span class="text-xs text-[#820000]">Cart</span>
                    </div>
                    <div class="flex-1 flex items-center justify-center">
                        <div class="h-1 w-full bg-[#820000]"></div>
                    </div>
                    <div class="flex flex-col items-center">
                        <div class="w-8 h-8 rounded-full bg-[#820000] text-white flex items-center justify-center mb-1">
            ...
            <form id="deliveryForm" class="p-4 space-y-6" onsubmit="event.preventDefault(); placeOrder();">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="fullName" required
                                   class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-[#820000]"
                ...
                <div class="fixed bottom-0 left-0 right-0 bg-white border-t shadow-lg p-4">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <div class="text-xl font-bold">${formatCurrency(finalTotal)}</div>
                    </div>
                    <button type="submit"
                            class="w-full bg-gradient-to-r from-[#820000] to-[#6b0000] text-white py-3 rounded-lg font-semibold flex items-center justify-center">
            ...
            <div class="bg-white sticky top-0 z-10 shadow-sm">
                <div class="flex items-center p-4">
                    ...
                    <div class="flex-1 relative">
                        <input type="text" 
                               placeholder="Search products..." 
                               class="w-full pl-10 pr-4 py-2 border rounded-lg focus:outline-none focus:border-[#820000]"
                               oninput="setSearchTerm(this.value)"
                               value="${searchTerm || ''}">
                        <i class="fas fa-search absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400"></i>
                    </div>
        ...
        <div class="pb-32">
            ...
            ${
                ...
                <div class="flex flex-col items-center justify-center p-8">
                    ...
                    <button onclick="navigate('home')" 
                            class="bg-[#820000] text-white px-6 py-2 rounded-lg font-semibold">
                        Start Shopping
                    </button>
                </div>
            `
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="border-t pt-2 mt-2">
                            <div class="flex justify-between">
                                ...
                                <span class="font-bold text-xl">${formatCurrency(calculateSubtotal())}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            ${
                ...
                <div class="fixed bottom-0 left-0 right-0 bg-white p-4 shadow-lg">
                    <button onclick="checkout()" 
                            class="w-full bg-[#820000] text-white py-3 rounded-lg font-semibold flex items-center justify-center">
                        <i class="fas fa-lock mr-2"></i>
                        Proceed to Checkout (${formatCurrency(calculateSubtotal())})
                    </button>
                </div>
            `
                    : ''
    ...
    return `
        <div class="flex flex-col items-center justify-center p-8">
            ...
            <form onsubmit="handleLogin(event)" class="space-y-4 w-full max-w-md">
                ...
                <button type="submit" class="w-full bg-[#820000] text-white py-3 rounded-lg font-semibold hover:bg-[#6b0000]">
                    Login
                </button>
            </form>
            <p class="text-gray-500 text-center mt-4">
                Don't have an account? <button onclick="navigate('signup')" class="text-[#820000]">Signup</button>
            </p>
        </div>
    `;
}
...
function renderSignup() {
    return `
        <div class="flex flex-col items-center justify-center p-8">
            ...
            <p class="text-gray-500 text-center mt-4">
                Already have an account? <button onclick="navigate('login')" class="text-[#820000]">Login</button>
            </p>
        </div>
    `;
}
...
async function loadCart() {
    try {
        ...
        // Check auth first
        const authResponse = await fetch(`${BASE_URL}/api/auth.php?action=check`, {
            credentials: 'include'
        });
        ...
        if (authData.status !== 'success') {
            cartContainer.innerHTML = `
                <div class="login-prompt">
                    ...
                    <a href="${BASE_URL}/login.php" class="login-button">Login</a>
                </div>
            `;
            return;
        }
        ...
        showNotification(error.message || 'Failed to load cart');
    }
}
            ...
            ${items.map(item => {
                ...
                return `
                    <div class="cart-item" data-id="${item.id}">
                        <img src="${item.image_url || BASE_URL + '/assets/images/placeholder.jpg'}" 
                             alt="${item.name}" 
...
async function removeFromCart(cartId) {
    try {
        const response = await fetch(`${BASE_URL}/api/cart.php?id=${cartId}`, {
            method: 'DELETE',
            credentials: 'include'
        });
...
function createProductCard(product) {
    const imageUrl = product.image_url || `${BASE_URL}/assets/images/placeholder.jpg`;
    return `
...
// Tambahkan error handling untuk notifications
...
// Tambahkan event listener untuk hash changes
...
async function loadHomeContent() {
    try {
        ...
        // Load featured products or any home content
        const response = await fetch(`${BASE_URL}/api/products.php?featured=1`);
        const data = await response.json();

        if (data.status === 'success') {
            // Update home content
            const featuredProducts = data.data.slice(0, 4); // Get first 4 products
            const featuredHTML = `
            ...
            heroSection.insertAdjacentHTML('afterend', featuredHTML);
        }
    } catch (error) {
        console.error('Failed to load home content:', error);
        showNotification('Error loading home content');
    }
}
...
async function updateCartCount() {
    try {
        ...
        if (cartCount) {
            cartCount.textContent = data.data.reduce((sum, item) => sum + item.quantity, 0);
        }
    } catch (error) {
