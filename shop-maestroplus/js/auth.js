...
function renderLogin() {
    return `
        <div class="auth-container">
            <div class="auth-card">
                <div class="auth-logo">
                    <i class="fas fa-shopping-bag text-4xl text-[#820000]"></i>
                </div>
                ...
                <form class="auth-form" onsubmit="handleLogin(event)">
                    ...
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <a href="#" class="text-sm text-[#820000] hover:text-[#6b0000]">Forgot Password?</a>
                    </div>
            ...
            <div class="auth-card">
                ...
                <form class="auth-form" onsubmit="handleSignup(event)">
                    ...
                    <div class="flex items-center mb-4">
                        ...
                        <label for="terms" class="ml-2 text-sm text-gray-600">
                            I agree to the <a href="#" class="text-[#820000] hover:text-[#6b0000]">Terms</a> and 
                            <a href="#" class="text-[#820000] hover:text-[#6b0000]">Privacy Policy</a>
                        </label>
                    </div>
                    ${authState.error ? `<div class="error-message">${authState.error}</div>` : ''}
                    <button type="submit" class="auth-button ripple">
                ...
                <div class="auth-footer">
                    <p>Already have an account? 
                        <a href="#" onclick="navigate('login')" class="text-[#820000] hover:text-[#6b0000] font-semibold">
                            Sign In
                        </a>
                    </p>
                </div>
